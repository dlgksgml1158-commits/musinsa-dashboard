"""무신사 파트너 일별 주문 통계 동기화.

notion-github-dashboard 저장소가 Playwright 로그인으로 직접 수집한
일별 주문건수/매출 데이터를 그대로 가져와 표시한다. 이 저장소에서는
로그인 인증을 하지 않는다.
"""
import json
import os
...
SOURCE_URL = (
    ...
    "notion-github-dashboard/main/data-b53e82ab173f/musinsa_order_stats.json"
)
OUT_PATH = "data/musinsa_order_stats.json"
